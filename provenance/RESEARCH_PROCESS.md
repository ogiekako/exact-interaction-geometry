...
The research ledger uses separate roles for:
...
This repository is not a mirror of the research ledger. The public tree contains only the small set of statements needed to understand and falsify the foundational EIG proposal.
