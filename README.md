...
> **Staging note (`staging/eig-core-canonical`):** [`EIG_CORE.md`](EIG_CORE.md) is the current candidate canonical Level-2 construction schema and is the first document to audit on this branch. It is intentionally not yet merged to `main`.

**Current foundational disclosure on `main`:** [`EIG_FOUNDATIONAL_DISCLOSURE_20260902.md`](EIG_FOUNDATIONAL_DISCLOSURE_20260902.md)  
...
On `staging/eig-core-canonical`, read [`EIG_CORE.md`](EIG_CORE.md) first. It is the branch's candidate canonical Core and the intended object of independent audit.

1. [`EIG_CORE.md`](EIG_CORE.md) — candidate canonical Level-2 construction schema on this staging branch.
2. [`EIG_FOUNDATIONAL_DISCLOSURE_20260902.md`](EIG_FOUNDATIONAL_DISCLOSURE_20260902.md) — current precise formulation on `main`.
3. [`EIG_IDENTIFIABILITY_BOUNDARIES_20260902.md`](EIG_IDENTIFIABILITY_BOUNDARIES_20260902.md) — boundary-first viewpoint and output schema.
4. [`FOUNDATIONS.md`](FOUNDATIONS.md) — minimal setup and proved calibrations.
5. [`theory/01-finite-exact-interactions.md`](theory/01-finite-exact-interactions.md) — smallest exact calculus.
6. [`theory/02-category-reconstruction.md`](theory/02-category-reconstruction.md) — exact object/typing/Hom reconstruction calibration.
...
9. [`STATUS.md`](STATUS.md) — detailed epistemic ledger.
10. [`ROADMAP.md`](ROADMAP.md) — broader open directions.
...
**Current main formulation:** 2026-09-02  
**Current canonical-core staging candidate:** 2026-09-03