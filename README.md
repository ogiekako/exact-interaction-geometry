...
8. [`PRIOR_ART.md`](PRIOR_ART.md) and [`CONTEMPORARY_NEIGHBORS.md`](CONTEMPORARY_NEIGHBORS.md) — novelty and neighbour boundary.
9. [`ROADMAP.md`](ROADMAP.md) — open gates.
10. [`EIG_FOUNDATIONAL_DISCLOSURE_20260901.md`](EIG_FOUNDATIONAL_DISCLOSURE_20260901.md) — preserved historical snapshot, with a later curation note where applicable.
